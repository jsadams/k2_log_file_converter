...
fn process_single_file(csv_filename:&str, output_dir: &str, file_count: &mut i32,
                       &total_delta_file_size: &i64, &processed_files: &i32, &total_files: &i32, bar: &ProgressBar)  -> Result<(), PolarsError>
{
